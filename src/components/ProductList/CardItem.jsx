            ...
            <div key={p.id} className="">
              ...
              <div className="relative h-36 lg:px-4 md:h-32">
                <div className="flex ">
                  ...
                  >
                    {p.name} - {p.category} - {p.shade} - {p.material} -{" "}
                    {p.brands}
                  </Link>
                  <div
                    className="text-xs text-rose-600 bg-white p-2 rounded-full md:text-sm"
                    onClick={(e) => {
                      e.preventDefault();
                      if (isInWishlist) {
                        subWishItemNumber();
  ...
  return (
    <div className="w-full m-4">
      ...
      <div className="flex my-10 items-center justify-between">
        <button
          className="border p-2 px-12 border-gray-400 rounded-xl flex max-sm:px-4"
        ...
        <button
          className="border p-2 px-12 border-gray-400 rounded-xl text-base max-sm:px-4 flex"
          onClick={() => handlePageChange(currentPage + 1)}
