    ...
    let filteredItems = itemData.filter(
      (item) =>
        ...
        (selectedDressStyle.length === 0 ||
          selectedDressStyle.includes(item.dresStyle)) &&
        ...
        <>
          ...
          <div className="w-full mt-5 flex flex-col gap-2">
            <ul className="text-[15px] leading-[30px] text-rose-700 font-medium">
              <label htmlFor="all">
                <li
                  ...
                  className="flex justify-between items-center cursor-pointer text-[0.9rem]"
                >
                  All <BiReset size={18} />
                </li>
              </label>
            ...
            <div className="w-full flex flex-col">
              ...
              >
                <p className="text-[15px] leading-[30px] text-rose-700 font-medium">
                  Shades
                </p>
                <IoIosArrowDown
                  size={15}
                  className={`transition-all duration-[0.3s] ease-in-out text-rose-700 ${
                    showShades ? "rotate-180" : "rotate-0"
                  }`}
                />
              </div>
              {showShades && (
                <div className="w-full flex flex-wrap gap-6 border-2 px-4 py-2 rounded-lg">
                  {menuColor.map((val) => (
                    <div
                      ...
                      className={`h-[30px] w-[30px] ${val} rounded-full cursor-pointer border-2 border-transparent ${
                        selectedColor === val
                          ? "border-x-black scale-[1.2] transition-all"
                          : ""
                      }`}
                    ></div>
                  ))}
            ...
            <div className="w-full flex flex-col">
              ...
              >
                ...
                <IoIosArrowDown
                  size={15}
                  className={`transition-all duration-[0.3s] ease-in-out text-rose-700 ${
                    showDressStyle ? "rotate-180" : "rotate-0"
                  }`}
                />
              </div>
              {showDressStyle && (
                <div className="flex flex-col border-2 px-4 py-2 rounded-lg">
                  {menuDressStyle.map((val, index) => (
                    <li
                      className="flex justify-between items-center text-[0.9rem] my-1"
                      key={index}
                    >
              ...
              <div className="">
                ...
                >
                  ...
                  <IoIosArrowDown
                    size={15}
                    className={`transition-all duration-[0.3s] ease-in-out text-rose-700 ${
                      showBrands ? "rotate-180" : "rotate-0"
                    }`}
                  />
                </div>
                {showBrands && (
            ...
            <div className="w-full">
              <ul className="text-[15px] leading-[30px] text-gray-600">
                <label htmlFor="all">
                  <li
                    ...
                    className="flex justify-between items-center text-[0.9rem] cursor-pointer"
                  >
                    All <BiReset size={20} />
                  </li>
                </label>
              ...
              <div className="w-full flex flex-col mt-4">
                <div
                  ...
                  onClick={() => setShowShades(!showShades)}
                >
                  <p className="text-[15px] leading-[30px] text-gray-700 font-medium">
                    Shades
                  </p>
                  <IoIosArrowDown
                    size={15}
                    className={`transition-all duration-[0.3s] ease-in-out text-gray-700 ${
                      showShades ? "rotate-180" : "rotate-0"
                    }`}
                  />
                </div>
