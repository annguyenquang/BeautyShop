...
const cardSlider = () => {
  const relatedProducts = [
    ...
    },
    {
      id: 3,
      src: img,
      title: "Konka OLED of Android Tv",
      price: "700.22",
      buttonText: "Add to cart",
      original_price: 12000,
      rating: 2.6,
    },
    {
      id: 4,
      src: img,
      title: "CL Roku Smart Android Tv",
      price: "800.22",
        ...
        {relatedProducts.map((data, i) => (
          ...
          >
            ...
            <div class="bg-white rounded-2xl p-5 cursor-pointer hover:-translate-y-2 transition-all relative">
              <div className="opacity-0 bg-black hover:opacity-100  hover:translate-y-2 hover:bg-opacity-20 absolute top-0 left-0 right-0 bottom-0 h-[100%] transition-all  flex items-center justify-center">
                c
                <Link to={""}>
              ...
              <div>
                ...
                <h4 class="text-lg text-rose-800 font-bold mt-4">
                  ${data.price}
                </h4>
              </div>
            </div>
