  ...
  return (
    <>
      <div className="heading md:pt-16 pt-8 md:pb-8">
        ...
        <h2 className="text-nowrap" data-aos="fade-up">
          Top Brands Products
        </h2>
              ...
              >
                <SwiperSlide className="rounded-xl w-full h-[100%] overflow-hidden group relative shadow-lg">
                  <img
                    src={product_1}
                    alt=""
                    className="w-full h-full object-cover transition group-hover:scale-110 duration-75"
                  />
                  <div className="absolute flex flex-col justify-between top-0 bottom-0 right-0 left-0 group-hover:bg-black/50">
                    <div>
                      <p className="text-xs md:text-sm lg:text-base pt-4 px-4 font-semibold hidden transition group-hover:flex text-white">
                        Vaseline Shea Butter for Glowing skin (180g), whipped
                        body butter
                      </p>
                      <p className="text-xs md:text-sm lg:text-base pt-4 px-4 font-semibold hidden transition group-hover:flex text-white">
                        $ 500
                    ...
                    <button className="text-center hidden group-hover:flex bg-rose-700 px-4 text-white font-medium text-base md:text-lg w-fit mr-auto rounded-tr-xl">
                      Buy Now
                    </button>
                  </div>
                </SwiperSlide>
