  ...
  return (
    <>
      ...
      <section className="mt-8 mb-4">
        ...
        >
          <SwiperSlide className="flex items-center justify-between w-fit h-full">
            <div className="flex flex-col items-center w-fit">
              <img
                src={product_11}
                alt="Top Products"
                className="w-24 h-24 md:w-28 md:h-28 lg:w-36 lg:h-36 rounded-full object-cover mb-2"
              />
