...
function Footer() {
  ...
  const [textStyle, cngTextStyle] = useState(
    "text-xs text-black transition hover:underline hover:text-rose-800"
  );
        ...
        >
          ...
          >
            {lst.chhotiList.map((list2, int) => {
              return (
                <li key={int}>
                  <Link to={list2.url} className={textStyle}>
                    {list2.txt}
                  </Link>
                </li>
              );
    ...
    <footer className="w-screen h-full lg:h-80 mt-4 relative">
      ...
      <div className={`absolute top-5 left-0 right-0 bottom-0 z-10`}>
        ...
        >
          ...
          >
            <Link to="/" className="logo mx-auto">
              <img
                alt=""
                className="object-contain sm:mr-[200px] mx-auto h-[5rem] w-[10rem] md:h-[10rem] md:w-22 mix-blend-overlay"
                src={Skinbidi}
              />
            </Link>
        ...
        <ul className="flex justify-center mt-6 gap-4 md:gap-6 w-full relative float-right md:py-4 pt-6 pb-2 md:mr-24 md:justify-end">
          ...
          <li>
            <a href="https://www.instagram.com/divueens/" className={textStyle}>
          ...
          <li>
            <a
              href="https://www.linkedin.com/company/divueens/about/"
              className={textStyle}
            >
          ...
          <div className="flex items-center md:gap-0 absolute -top-6 md:top-0 md:right-[20%] lg:right-40 md:bottom-0 w-fit h-12">
            <img
              src={Google}
              className="w-24 h-[2.5rem] md:w-36 md:h-12"
              alt=""
            />
            <img
              src={Apple}
        ...
        <hr
          data-footer-part=""
          className="mt-6 mx-4 mb-3 border-none h-[0.6px] bg-black"
        />

        <div className="py-2 md:py-4 ">
          <div className="sm:flex sm:justify-between">
            <p
              className="copyright text-xs md:text-base pb-3 md:pb-0 text-black md:ml-20"
              data-footer-part=""
            >
            ...
            <ul className="flex flex-wrap justify-center md:mr-20 md:gap-4 gap-2 text-[0.6rem] sm:mt-0">
              <li>
                <Link
                  ...
                  className="text-black/80 transition hover:text-slate-800 hover:underline"
                >
                  Terms & Conditions
                </Link>
              </li>
